...
<h4 class="mb-2"><strong>𝘼𝙐𝙏𝙊𝘾𝙃𝙀𝘾𝙆𝙀𝙍</strong></h4>
...
Swal.fire({ title: "Welcome!", text: "Enjoy doing checkouts!", icon: "info", confirmButtonText: "Alright", confirmButtonColor: "#00ff99", buttonsStyling: false, confirmButtonClass: 'btn btn-primary', footer: '<a href="https://t.me/rosebot">Let me know if there is any issues.</a>'});
...
if(total > 10){
  Swal.fire({title: 'Try 10+ ccs ', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
  return false;
}
